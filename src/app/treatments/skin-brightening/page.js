        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Achieve a luminous, even complexion with our specialized skin 
              brightening treatments tailored to your skin type.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Skin brightening treatments target pigmentation, dark spots, and 
                uneven skin tone to reveal a clearer, more radiant complexion. 
                Our dermatologists create customized treatment plans based on your 
                specific skin concerns.
              </p>
              <p className="text-gray-600">
                Using FDA-approved technologies and medical-grade products, we 
                safely and effectively brighten your skin.
              </p>
            </div>
      ...
      <section className="py-20 bg-[#F7FAFC]">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-[#0B0F19] text-center mb-12">
            Our Brightening Solutions
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "Chemical Peels",
                description: "Exfoliate and renew skin with customized chemical peel treatments.",
              },
              {
                title: "Laser Therapy",
                description: "Target pigmentation and dark spots with advanced laser technology.",
              },
              {
                title: "Glutathione Treatment",
                description: "Systemic skin brightening with powerful antioxidant therapy.",
              },
            ].map((item, index) => (
