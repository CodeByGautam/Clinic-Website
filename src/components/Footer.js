        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex gap-4">
              {["facebook", "twitter", "instagram", "linkedin"].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#00A651] transition-colors"
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-gray-400 hover:text-[#00A651] transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-3">
              {treatments.map((treatment) => (
                <li key={treatment.name}>
                  <Link href={treatment.href} className="text-gray-400 hover:text-[#00A651] transition-colors">
                    {treatment.name}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+911234567890" className="text-white hover:text-[#00A651] transition-colors">
                    +91 1234 567 890
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:healthfusion33@gmail.com" className="text-white hover:text-[#00A651] transition-colors">
